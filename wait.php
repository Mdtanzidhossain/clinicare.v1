	...
	<section class="listings" style="background-color:white;">
		<div class="wrapper">
			<ul class="properties_list">
				<h2 style="text-align:center; color:black; font-family: 'Courier New', Courier, monospace">
					Thanks for Taking ambulance service from Clinicare-TM. <br>Take a look on <a href="http://localhost/clinicare/ambulance/status.php">view status</a> Portal for the Booking update. 
				</h2>
			</ul>
