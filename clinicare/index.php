...
<head>
    ...
    <title>CliniCare Medicineshop</title>
...
<body >
 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>Budget friendly Medicine shop</h3>
                           <h1>order medicine 24/7</h1>
                        ...
                        <li>
                            <h3>Every kind of medicine</h3>
                           <h1>WE HAVE ALL BRANDS Medicine</h1>
                             <a  href="#features-sec" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#ln">
                                SIGN IN
                            </a>
                             <a  href="#features-sec" class="btn btn-success btn-lg" data-toggle="modal" data-target="#su">
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE CliniCare Medicineshop <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div ">
                        <h4> House no-14,Road-17,Kemal Attartuk Avenue</h4>
                        <h4>Banani 1213,Bangladesh</h4>
						<h4>8200</h4>
        ...
        <hr />
                    <div >
                        ...
                        <h4><strong>Email: </strong>clinicare@gmail.com</h4>
                    </div>
                    </div>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy  cliniCare| All Rights Reserved |  <a style="color: #fff" target="_blank">Design by : cliniCare Team</a>
    </div>
     <!-- FOOTER SECTION END-->
