        ...
        <div id="page-wrapper">
		 ...
		 <div class="alert alert-danger">
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  <?php
include("config.php");
	$stmt = $DB_con->prepare('select order_id, order_date,patient.first_name, patient.last_name, order_name, order_price, order_quantity, order_total from orderdetails, patient where orderdetails.patient_id=patient.patient_id and order_status="Ordered" order by order_date desc');
	$stmt->execute();
