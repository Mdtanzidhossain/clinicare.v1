...
<head>
    ...
    <title>CliniCare Medicine Shop</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">CliniCare - Administrator Panel</a>
            </div>
...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-danger">
                        ...
                        &nbsp; &nbsp; Welcome to CliniCare Medicineshop! So, if you're looking for any type medicine, why not visit the CliniCare Medicineshop? 
						this is the easiest and most straightforward way to get it.A lot of medicine can be found here,.
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy  cliniCare Medicine shop| All Rights Reserved |  Design by : cliniCare Team
