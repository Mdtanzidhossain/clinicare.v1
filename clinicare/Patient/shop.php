...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is our drugs stocks, Shop now!</h3></center>
        </div>
...
mysqli_select_db($conn,"clinicare");
...
?>
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy  CliniCare| All Rights Reserved |  Design by : CliniCare Team
				 ...
				 <form enctype="multipart/form-data" method="post" action="settings.php">
                   <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Firstname" name="user_firstname" type="text" value="<?php  echo $first_name; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Lastname" name="user_lastname" type="text" value="<?php  echo $las_tname; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Address" name="user_address" type="text" value="<?php  echo $address; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Password" name="user_password" type="password" value="<?php  echo $pasword; ?>" required>
							...
							<div class="form-group">
                                ...
                                <input class="form-control hide" name="user_id" type="text" value="<?php  echo $patient_id; ?>" required>
