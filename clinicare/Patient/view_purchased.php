    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">CliniCare Drugstore</a>
            </div>
...
include("config.php");
	...
	$stmt = $DB_con->prepare("SELECT * FROM orderdetails where order_status='Ordered_Finished' and patient_id='$patient_id'");
	$stmt->execute();
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo '<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       & cliniCare medicine shop| All Rights Reserved |  Design by : cliniCare Team
				 ...
				 <form enctype="multipart/form-data" method="post" action="settings.php">
                   <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Lastname" name="user_lastname" type="text" value="<?php  echo $last_name; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Address" name="user_address" type="text" value="<?php  echo $location_id; ?>" required>
