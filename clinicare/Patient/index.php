...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-info">
                        ...
                        &nbsp; &nbsp; Welcome to CliniCare Drug Store!
						It's that easy. If you have any medicine. 
						this is the easiest and most straightforward way to get it.All type drugs are available here.
                    </div>
					<br />
			
			<div class="alert alert-default" style="background-color:#033c73;">
                       <p style="color:white;text-align:center;">
                       &copy 2021 CliniCare Drug Store| All Rights Reserved |  Design by : CliniCare Team
				 ...
				 <form enctype="multipart/form-data" method="post" action="settings.php">
                   <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Firstname" name="first_name" type="text" value="<?php  echo $firs_tname; ?>" required>
